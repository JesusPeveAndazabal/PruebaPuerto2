...
export class ControlComponent  implements OnInit {
  ...
  async ngOnInit() {
    ...
    combineLatest([
      ...
      if(this.arduinoService.isRunning){
        if(this.pressure < this.info * 0.5 || this.pressure > this.info * 1.5 || this.waterFlow < this.caudalNominal * 0.5 || this.waterFlow > this.caudalNominal * 1.5 || this.speed < this.speedalert * 0.5 || this.speed > this.speedalert * 1.5){
          this.emergencia = true;
        }else{
          this.emergencia = false;
        }
